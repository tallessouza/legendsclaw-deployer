...
You have 32 skills organized in 6 categories. Only **always-on** skills are fully loaded. For others, read the full SKILL.md on demand.
...
| **dev** | react-best-practices, composition-patterns, web-design-guidelines, vercel-deploy, react-native-skills | `read_file skills/dev/{name}/SKILL.md` |
