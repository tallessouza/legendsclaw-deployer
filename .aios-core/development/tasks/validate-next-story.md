...
- Identify and load the following inputs:
  ...
  - **Story template**: `.aios-core/product/templates/story-tmpl.yaml` for completeness validation

### 1. Template Completeness Validation

- Load `.aios-core/product/templates/story-tmpl.yaml` and extract all section headings from the template
