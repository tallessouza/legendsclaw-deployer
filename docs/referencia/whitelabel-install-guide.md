...
*Guia gerado por @architect (Aria) — Arquitetando o futuro 🏗️*
 quero um squad para fazer esse processo de ponta a ponta com a possibilidade de rodar localmente também adaptando o que for necessário mas garantindo que tudo esteja implementado
